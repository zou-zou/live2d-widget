/*
 * Live2D Widget
 * https://github.com/zou-zou/live2d-widget
 */
...
function loadWidget(config) {
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://github.com/zou-zou/live2d-widget");
		});
    ...
    function loadRandTextures() {
        ...
        $.ajax({
            ...
            url: `${cdnPath}switch_textures/?id=${modelId}-${modelTexturesId}`,
            dataType: "json",
